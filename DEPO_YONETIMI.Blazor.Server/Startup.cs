...
using DEPO_YONETIMI.Blazor.Server.Services;
...
namespace DEPO_YONETIMI.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<DEPO_YONETIMIBlazorApplication>(Configuration);
            ...
            services.AddXafSecurity(options => {
                ...
                options.UserType = typeof(DEPO_YONETIMI.Module.BusinessObjects.ApplicationUser);
                // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                options.UserLoginInfoType = typeof(DEPO_YONETIMI.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            services.AddSwaggerGen(c => {
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "DEPO_YONETIMI API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the DEPO_YONETIMI.Blazor.Server\Startup.cs file to make Business Objects available in Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
            if(env.IsDevelopment()) {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "DEPO_YONETIMI WebApi v1");
                });
            }
            else {
