...
namespace DEPO_YONETIMI.Blazor.Server {
    public partial class DEPO_YONETIMIBlazorApplication : BlazorApplication {
        public DEPO_YONETIMIBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void DEPO_YONETIMIBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
